    ...
    <div className="bgCover" style={{zIndex:"1"}}  >  <img  src={IMG3} alt="footer"  /> </div>
      ...
      <div className="top">
        ...
        <ul className='social last-social'>
          <li > <Link to={Social_Media[0]} target="_blank" className="Iicon"> <div className="style"> <i className="fa-brands fa-facebook-f"></i>    </div> </Link></li>
          <li > <Link to={Social_Media[1]} target="_blank" className="Iicon"> <div className="style"> <i className="fa-brands fa-instagram"></i></div> </Link></li>
          <li > <Link to={Social_Media[3]} target="_blank" className="Iicon"> <div className="style"><i className="fa-brands fa-whatsapp"></i>        </div> </Link></li>
          <li > <Link to={Social_Media[2]} target="_blank" className="Iicon"> <div className="style"> <i className="fa-brands fa-linkedin-in"></i></div> </Link></li>
        </ul>
      </div>
